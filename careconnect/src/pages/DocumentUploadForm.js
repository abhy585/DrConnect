  ...
  return (
    <Form method="post" action="/create" onSubmit={handleClick}>
      ...
      <FormControl isRequired mb="40px">
        <FormLabel mx="2px" my="2px">Choose the type of Report: </FormLabel>
      ...
      <FormControl isRequired mb="40px" maxW="250px" >
        <FormLabel mx="2px" my="2px" >Choose File: </FormLabel>
        <Input display="block"  type = "file" name="file" onChange={ev => setFiles(ev.target.files)} mt="10px" mb="10px" mx="-2px" border="none"/>
      </FormControl>
