    ...
    < SimpleGrid spacing={10} minChildWidth="300px" >
      ...
      {tasks && tasks.map(task => (
        ...
        <Card key={task.id} borderTop="8px" borderColor="purple.600" >
          ...
          <CardFooter>
            <HStack>
              <Button variant="ghost" leftIcon={<ViewIcon />} onClick={onOpen}>Watch</Button>
              ...
              <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                  ...
                  <ModalBody>
                    ...
                    <List fontSize="1.2em" spacing={4}>
                      ...
                      <ListItem>
                        <ListIcon as={AtSignIcon} />
                        Doctor's history :
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Architecto cum perspiciatis modi atque dolores dolorum ipsum quibusdam soluta a? Aspernatur numquam excepturi, omnis inventore atque eum magni debitis. Debitis tempora, expedita suscipit voluptates neque veritatis minima, magni necessitatibus iusto asperiores sunt earum officiis sint totam! Perferendis ratione officia deserunt voluptatibus!
                      </ListItem>
                    </List>
                  ...
                  <ModalFooter>
                  <Button variant="ghost" mr={3}>Connect</Button>
